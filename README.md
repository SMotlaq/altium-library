...
The library is compatible with Altium Designer version 21.0 and later. To use the library, simply [download the latest release](https://github.com/SMotlaq/altium-library/releases/), and place the IntLib file in the appropriate locations on your computer, then install it on the Altium Designer.
